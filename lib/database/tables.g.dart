...
class $WalletsTable extends Wallets
  ...
  static const VerificationMeta _walletPkMeta = const VerificationMeta(
    'walletPk',
  );
  @override
  ...
  static const VerificationMeta _currencyFormatMeta = const VerificationMeta(
    'currencyFormat',
  );
  @override
  ...
  late final GeneratedColumnWithTypeConverter<
    List<HomePageWidgetDisplay>?,
    String
  >
  homePageWidgetDisplay = GeneratedColumn<String>(
  ...
  VerificationContext validateIntegrity(
    Insertable<TransactionWallet> instance, {
    ...
    return TransactionWallet(
      walletPk:
          attachedDatabase.typeMapping.read(
            DriftSqlType.string,
            data['${effectivePrefix}wallet_pk'],
          )!,
      name:
          attachedDatabase.typeMapping.read(
            DriftSqlType.string,
      ...
      currencyFormat: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}currency_format'],
      ),
      decimals:
          attachedDatabase.typeMapping.read(
            DriftSqlType.int,
  ...
  static TypeConverter<List<HomePageWidgetDisplay>?, String?>
  $converterhomePageWidgetDisplayn = NullAwareTypeConverter.wrap(
    $converterhomePageWidgetDisplay,
  );
}
...
class TransactionWallet extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || homePageWidgetDisplay != null) {
      map['home_page_widget_display'] = Variable<String>(
        $WalletsTable.$converterhomePageWidgetDisplayn.toSql(
          homePageWidgetDisplay,
        ),
      );
    }
  ...
  WalletsCompanion toCompanion(bool nullToAbsent) {
    return WalletsCompanion(
      ...
      dateTimeModified:
          dateTimeModified == null && nullToAbsent
              ? const Value.absent()
      ...
      currency:
          currency == null && nullToAbsent
              ...
              : Value(currency),
      currencyFormat:
          currencyFormat == null && nullToAbsent
              ? const Value.absent()
              : Value(currencyFormat),
      decimals: Value(decimals),
      homePageWidgetDisplay:
          homePageWidgetDisplay == null && nullToAbsent
              ? const Value.absent()
              : Value(homePageWidgetDisplay),
    );
  }

  factory TransactionWallet.fromJson(
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'homePageWidgetDisplay': serializer.toJson<List<HomePageWidgetDisplay>?>(
        homePageWidgetDisplay,
      ),
    };
  }
...
class $CategoriesTable extends Categories
  ...
  static const VerificationMeta _categoryPkMeta = const VerificationMeta(
    'categoryPk',
  );
  @override
  ...
  static const VerificationMeta _emojiIconNameMeta = const VerificationMeta(
    'emojiIconName',
  );
  @override
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('category_pk')) {
      context.handle(
        _categoryPkMeta,
        categoryPk.isAcceptableOrUnknown(data['category_pk']!, _categoryPkMeta),
      );
    }
    if (data.containsKey('name')) {
      context.handle(
  ...
  TransactionCategory map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return TransactionCategory(
      categoryPk:
          attachedDatabase.typeMapping.read(
            DriftSqlType.string,
            data['${effectivePrefix}category_pk'],
          )!,
      name:
          attachedDatabase.typeMapping.read(
            DriftSqlType.string,
      ...
      emojiIconName: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}emoji_icon_name'],
      ),
      dateCreated:
          attachedDatabase.typeMapping.read(
            DriftSqlType.dateTime,
...
class TransactionCategory extends DataClass
    ...
    return CategoriesCompanion(
      ...
      iconName:
          iconName == null && nullToAbsent
              ...
              : Value(iconName),
      emojiIconName:
          emojiIconName == null && nullToAbsent
              ? const Value.absent()
              : Value(emojiIconName),
      dateCreated: Value(dateCreated),
      dateTimeModified:
      ...
      income: Value(income),
      methodAdded:
          methodAdded == null && nullToAbsent
              ? const Value.absent()
              : Value(methodAdded),
      mainCategoryPk:
          mainCategoryPk == null && nullToAbsent
              ? const Value.absent()
  ...
  factory TransactionCategory.fromJson(
    ...
    return TransactionCategory(
      ...
      methodAdded: $CategoriesTable.$convertermethodAddedn.fromJson(
        serializer.fromJson<int?>(json['methodAdded']),
      ),
...
class $ObjectivesTable extends Objectives
  ...
  static const VerificationMeta _objectivePkMeta = const VerificationMeta(
    'objectivePk',
  );
  @override
  ...
  static const VerificationMeta _walletFkMeta = const VerificationMeta(
    'walletFk',
  );
  @override
  ...
  Objective map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Objective(
      objectivePk:
          attachedDatabase.typeMapping.read(
            DriftSqlType.string,
            data['${effectivePrefix}objective_pk'],
          )!,
      type: $ObjectivesTable.$convertertype.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
      ...
      walletFk:
          attachedDatabase.typeMapping.read(
            DriftSqlType.string,
            data['${effectivePrefix}wallet_fk'],
          )!,
    );
  }
...
class Objective extends DataClass implements Insertable<Objective> {
  ...
  factory Objective.fromJson(
    ...
    return Objective(
      ...
      type: $ObjectivesTable.$convertertype.fromJson(
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'type': serializer.toJson<int>(
        $ObjectivesTable.$convertertype.toJson(type),
      ),
      'name': serializer.toJson<String>(name),
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (type.present) {
      map['type'] = Variable<int>(
        $ObjectivesTable.$convertertype.toSql(type.value),
      );
    }
    if (name.present) {
      map['name'] = Variable<String>(name.value);
...
class $TransactionsTable extends Transactions
  ...
  static const VerificationMeta _transactionPkMeta = const VerificationMeta(
    'transactionPk',
  );
  @override
  ...
  static const VerificationMeta _categoryFkMeta = const VerificationMeta(
    'categoryFk',
  );
  @override
  ...
  static const VerificationMeta _subCategoryFkMeta = const VerificationMeta(
    'subCategoryFk',
  );
  @override
  ...
  static const VerificationMeta _originalDateDueMeta = const VerificationMeta(
    'originalDateDue',
  );
  @override
  ...
  reoccurrence = GeneratedColumn<int>(
    'reoccurrence',
    aliasedName,
    true,
    type: DriftSqlType.int,
  ...
  late final GeneratedColumn<bool> upcomingTransactionNotification =
      GeneratedColumn<bool>(
        'upcoming_transaction_notification',
        aliasedName,
        true,
        type: DriftSqlType.bool,
        requiredDuringInsert: false,
  ...
  type = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: false,
  ).withConverter<TransactionSpecialType?>($TransactionsTable.$convertertypen);
  ...
  late final GeneratedColumn<bool> createdAnotherFutureTransaction =
      GeneratedColumn<bool>(
        'created_another_future_transaction',
        aliasedName,
        true,
        type: DriftSqlType.bool,
        requiredDuringInsert: false,
  ...
  late final GeneratedColumnWithTypeConverter<MethodAdded?, int> methodAdded =
      GeneratedColumn<int>(
        ...
        type: DriftSqlType.int,
        requiredDuringInsert: false,
      ).withConverter<MethodAdded?>($TransactionsTable.$convertermethodAddedn);
  ...
  late final GeneratedColumn<String> transactionOriginalOwnerEmail =
      GeneratedColumn<String>(
        'transaction_original_owner_email',
        aliasedName,
        true,
        type: DriftSqlType.string,
        requiredDuringInsert: false,
  ...
  static const VerificationMeta _sharedOldKeyMeta = const VerificationMeta(
    'sharedOldKey',
  );
  @override
  ...
  static const VerificationMeta _sharedDateUpdatedMeta = const VerificationMeta(
    'sharedDateUpdated',
  );
  @override
  ...
  static const VerificationMeta _objectiveLoanFkMeta = const VerificationMeta(
    'objectiveLoanFk',
  );
  @override
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('category_fk')) {
      context.handle(
        _categoryFkMeta,
        categoryFk.isAcceptableOrUnknown(data['category_fk']!, _categoryFkMeta),
      );
    } else if (isInserting) {
  ...
  Transaction map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Transaction(
      transactionPk:
          attachedDatabase.typeMapping.read(
            DriftSqlType.string,
            data['${effectivePrefix}transaction_pk'],
          )!,
      pairedTransactionFk: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}paired_transaction_fk'],
      ),
      name:
          attachedDatabase.typeMapping.read(
            DriftSqlType.string,
      ...
      categoryFk:
          attachedDatabase.typeMapping.read(
            DriftSqlType.string,
            data['${effectivePrefix}category_fk'],
          )!,
      subCategoryFk: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}sub_category_fk'],
      ),
      walletFk:
          attachedDatabase.typeMapping.read(
            DriftSqlType.string,
      ...
      originalDateDue: attachedDatabase.typeMapping.read(
        DriftSqlType.dateTime,
        data['${effectivePrefix}original_date_due'],
      ),
      income:
          attachedDatabase.typeMapping.read(
            DriftSqlType.bool,
      ...
      type: $TransactionsTable.$convertertypen.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
          data['${effectivePrefix}type'],
        ),
      ...
      sharedOldKey: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}shared_old_key'],
      ),
      sharedStatus: $TransactionsTable.$convertersharedStatusn.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
          data['${effectivePrefix}shared_status'],
        ),
      ),
      ...
      objectiveLoanFk: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}objective_loan_fk'],
      ),
  ...
  $converterreoccurrence = const EnumIndexConverter<BudgetReoccurence>(
    BudgetReoccurence.values,
  );
  static JsonTypeConverter2<BudgetReoccurence?, int?, int?>
  $converterreoccurrencen = JsonTypeConverter2.asNullable(
...
class Transaction extends DataClass implements Insertable<Transaction> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || upcomingTransactionNotification != null) {
      map['upcoming_transaction_notification'] = Variable<bool>(
        upcomingTransactionNotification,
      );
    }
    if (!nullToAbsent || type != null) {
      map['type'] = Variable<int>(
        $TransactionsTable.$convertertypen.toSql(type),
      );
    }
    map['paid'] = Variable<bool>(paid);
    if (!nullToAbsent || createdAnotherFutureTransaction != null) {
      map['created_another_future_transaction'] = Variable<bool>(
        createdAnotherFutureTransaction,
      );
    }
    ...
    if (!nullToAbsent || transactionOriginalOwnerEmail != null) {
      map['transaction_original_owner_email'] = Variable<String>(
        transactionOriginalOwnerEmail,
      );
    }
    ...
    if (!nullToAbsent || sharedReferenceBudgetPk != null) {
      map['shared_reference_budget_pk'] = Variable<String>(
        sharedReferenceBudgetPk,
      );
    }
    ...
    if (!nullToAbsent || budgetFksExclude != null) {
      map['budget_fks_exclude'] = Variable<String>(
        $TransactionsTable.$converterbudgetFksExcluden.toSql(budgetFksExclude),
      );
    }
    return map;
  }
  ...
  TransactionsCompanion toCompanion(bool nullToAbsent) {
    return TransactionsCompanion(
      ...
      pairedTransactionFk:
          pairedTransactionFk == null && nullToAbsent
              ? const Value.absent()
      ...
      subCategoryFk:
          subCategoryFk == null && nullToAbsent
              ? const Value.absent()
              : Value(subCategoryFk),
      walletFk: Value(walletFk),
      dateCreated: Value(dateCreated),
      dateTimeModified:
          dateTimeModified == null && nullToAbsent
              ...
              : Value(dateTimeModified),
      originalDateDue:
          originalDateDue == null && nullToAbsent
              ? const Value.absent()
              : Value(originalDateDue),
      income: Value(income),
      periodLength:
          periodLength == null && nullToAbsent
              ? const Value.absent()
              : Value(periodLength),
      reoccurrence:
          reoccurrence == null && nullToAbsent
              ? const Value.absent()
              : Value(reoccurrence),
      endDate:
          endDate == null && nullToAbsent
      ...
      methodAdded:
          methodAdded == null && nullToAbsent
              ...
              : Value(methodAdded),
      transactionOwnerEmail:
          transactionOwnerEmail == null && nullToAbsent
              ? const Value.absent()
      ...
      sharedKey:
          sharedKey == null && nullToAbsent
              ? const Value.absent()
              : Value(sharedKey),
      sharedOldKey:
          sharedOldKey == null && nullToAbsent
              ? const Value.absent()
              : Value(sharedOldKey),
      sharedStatus:
          sharedStatus == null && nullToAbsent
              ? const Value.absent()
              : Value(sharedStatus),
      sharedDateUpdated:
          sharedDateUpdated == null && nullToAbsent
              ? const Value.absent()
              : Value(sharedDateUpdated),
      sharedReferenceBudgetPk:
          sharedReferenceBudgetPk == null && nullToAbsent
              ? const Value.absent()
              : Value(sharedReferenceBudgetPk),
      objectiveFk:
          objectiveFk == null && nullToAbsent
              ? const Value.absent()
              : Value(objectiveFk),
      objectiveLoanFk:
          objectiveLoanFk == null && nullToAbsent
              ? const Value.absent()
              : Value(objectiveLoanFk),
      budgetFksExclude:
          budgetFksExclude == null && nullToAbsent
              ? const Value.absent()
  ...
  factory Transaction.fromJson(
    ...
    return Transaction(
      ...
      pairedTransactionFk: serializer.fromJson<String?>(
        json['pairedTransactionFk'],
      ),
      name: serializer.fromJson<String>(json['name']),
      amount: serializer.fromJson<double>(json['amount']),
      ...
      reoccurrence: $TransactionsTable.$converterreoccurrencen.fromJson(
        serializer.fromJson<int?>(json['reoccurrence']),
      ),
      endDate: serializer.fromJson<DateTime?>(json['endDate']),
      upcomingTransactionNotification: serializer.fromJson<bool?>(
        json['upcomingTransactionNotification'],
      ),
      type: $TransactionsTable.$convertertypen.fromJson(
        serializer.fromJson<int?>(json['type']),
      ),
      paid: serializer.fromJson<bool>(json['paid']),
      createdAnotherFutureTransaction: serializer.fromJson<bool?>(
        json['createdAnotherFutureTransaction'],
      ),
      skipPaid: serializer.fromJson<bool>(json['skipPaid']),
      methodAdded: $TransactionsTable.$convertermethodAddedn.fromJson(
        serializer.fromJson<int?>(json['methodAdded']),
      ),
      transactionOwnerEmail: serializer.fromJson<String?>(
        json['transactionOwnerEmail'],
      ),
      transactionOriginalOwnerEmail: serializer.fromJson<String?>(
        json['transactionOriginalOwnerEmail'],
      ),
      sharedKey: serializer.fromJson<String?>(json['sharedKey']),
      sharedOldKey: serializer.fromJson<String?>(json['sharedOldKey']),
      sharedStatus: $TransactionsTable.$convertersharedStatusn.fromJson(
        serializer.fromJson<int?>(json['sharedStatus']),
      ),
      sharedDateUpdated: serializer.fromJson<DateTime?>(
        json['sharedDateUpdated'],
      ),
      sharedReferenceBudgetPk: serializer.fromJson<String?>(
        json['sharedReferenceBudgetPk'],
      ),
      objectiveFk: serializer.fromJson<String?>(json['objectiveFk']),
      objectiveLoanFk: serializer.fromJson<String?>(json['objectiveLoanFk']),
      budgetFksExclude: serializer.fromJson<List<String>?>(
        json['budgetFksExclude'],
      ),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'endDate': serializer.toJson<DateTime?>(endDate),
      'upcomingTransactionNotification': serializer.toJson<bool?>(
        upcomingTransactionNotification,
      ),
      'type': serializer.toJson<int?>(
        $TransactionsTable.$convertertypen.toJson(type),
      ),
      'paid': serializer.toJson<bool>(paid),
      'createdAnotherFutureTransaction': serializer.toJson<bool?>(
        createdAnotherFutureTransaction,
      ),
      ...
      'transactionOwnerEmail': serializer.toJson<String?>(
        transactionOwnerEmail,
      ),
      'transactionOriginalOwnerEmail': serializer.toJson<String?>(
        transactionOriginalOwnerEmail,
      ),
      ...
      'sharedReferenceBudgetPk': serializer.toJson<String?>(
        sharedReferenceBudgetPk,
      ),
  ...
  Transaction copyWith({
    ...
    dateTimeModified:
        dateTimeModified.present
            ...
            : this.dateTimeModified,
    originalDateDue:
        originalDateDue.present ? originalDateDue.value : this.originalDateDue,
    income: income ?? this.income,
    periodLength: periodLength.present ? periodLength.value : this.periodLength,
    reoccurrence: reoccurrence.present ? reoccurrence.value : this.reoccurrence,
    endDate: endDate.present ? endDate.value : this.endDate,
    upcomingTransactionNotification:
        upcomingTransactionNotification.present
            ? upcomingTransactionNotification.value
            : this.upcomingTransactionNotification,
    type: type.present ? type.value : this.type,
    paid: paid ?? this.paid,
    createdAnotherFutureTransaction:
        createdAnotherFutureTransaction.present
            ? createdAnotherFutureTransaction.value
            : this.createdAnotherFutureTransaction,
    skipPaid: skipPaid ?? this.skipPaid,
    methodAdded: methodAdded.present ? methodAdded.value : this.methodAdded,
    transactionOwnerEmail:
        transactionOwnerEmail.present
            ? transactionOwnerEmail.value
            : this.transactionOwnerEmail,
    transactionOriginalOwnerEmail:
        transactionOriginalOwnerEmail.present
            ? transactionOriginalOwnerEmail.value
            : this.transactionOriginalOwnerEmail,
    sharedKey: sharedKey.present ? sharedKey.value : this.sharedKey,
    sharedOldKey: sharedOldKey.present ? sharedOldKey.value : this.sharedOldKey,
    sharedStatus: sharedStatus.present ? sharedStatus.value : this.sharedStatus,
    sharedDateUpdated:
        sharedDateUpdated.present
            ? sharedDateUpdated.value
            : this.sharedDateUpdated,
    sharedReferenceBudgetPk:
        sharedReferenceBudgetPk.present
            ? sharedReferenceBudgetPk.value
            : this.sharedReferenceBudgetPk,
    objectiveFk: objectiveFk.present ? objectiveFk.value : this.objectiveFk,
    objectiveLoanFk:
        objectiveLoanFk.present ? objectiveLoanFk.value : this.objectiveLoanFk,
    budgetFksExclude:
        budgetFksExclude.present
  ...
  Transaction copyWithCompanion(TransactionsCompanion data) {
    return Transaction(
      transactionPk:
          data.transactionPk.present
              ? data.transactionPk.value
              : this.transactionPk,
      pairedTransactionFk:
          data.pairedTransactionFk.present
      ...
      dateTimeModified:
          data.dateTimeModified.present
              ...
              : this.dateTimeModified,
      originalDateDue:
          data.originalDateDue.present
              ? data.originalDateDue.value
              : this.originalDateDue,
      income: data.income.present ? data.income.value : this.income,
      periodLength:
          data.periodLength.present
              ? data.periodLength.value
              : this.periodLength,
      reoccurrence:
          data.reoccurrence.present
...
class TransactionsCompanion extends UpdateCompanion<Transaction> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (pairedTransactionFk.present) {
      map['paired_transaction_fk'] = Variable<String>(
        pairedTransactionFk.value,
      );
    }
    if (name.present) {
    ...
    if (type.present) {
      map['type'] = Variable<int>(
        $TransactionsTable.$convertertypen.toSql(type.value),
      );
    }
    if (paid.present) {
    ...
    if (transactionOwnerEmail.present) {
      map['transaction_owner_email'] = Variable<String>(
        transactionOwnerEmail.value,
      );
    }
    ...
    if (budgetFksExclude.present) {
      map['budget_fks_exclude'] = Variable<String>(
        $TransactionsTable.$converterbudgetFksExcluden.toSql(
          budgetFksExclude.value,
        ),
      );
    }
...
class $BudgetsTable extends Budgets with TableInfo<$BudgetsTable, Budget> {
  ...
  static const VerificationMeta _budgetPkMeta = const VerificationMeta(
    'budgetPk',
  );
  @override
  ...
  @override
  late final GeneratedColumnWithTypeConverter<List<String>?, String>
  categoryFks = GeneratedColumn<String>(
    'category_fks',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  categoryFksExclude = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
  ).withConverter<List<String>?>($BudgetsTable.$convertercategoryFksExcluden);
  static const VerificationMeta _incomeMeta = const VerificationMeta('income');
  @override
  late final GeneratedColumn<bool> income = GeneratedColumn<bool>(
    'income',
  ...
  reoccurrence = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: false,
  ).withConverter<BudgetReoccurence?>($BudgetsTable.$converterreoccurrencen);
  static const VerificationMeta _dateCreatedMeta = const VerificationMeta(
    'dateCreated',
  );
  @override
  ...
  @override
  late final GeneratedColumnWithTypeConverter<
    List<BudgetTransactionFilters>?,
    String
  >
  budgetTransactionFilters = GeneratedColumn<String>(
  ...
  sharedAllMembersEver = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
  ).withConverter<List<String>?>($BudgetsTable.$convertersharedAllMembersEvern);
  ...
  Budget map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Budget(
      budgetPk:
          attachedDatabase.typeMapping.read(
            DriftSqlType.string,
            data['${effectivePrefix}budget_pk'],
          )!,
      name:
          attachedDatabase.typeMapping.read(
            DriftSqlType.string,
      ...
      walletFks: $BudgetsTable.$converterwalletFksn.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}wallet_fks'],
        ),
      ),
      categoryFks: $BudgetsTable.$convertercategoryFksn.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}category_fks'],
        ),
      ),
      ...
      sharedMembers: $BudgetsTable.$convertersharedMembersn.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}shared_members'],
        ),
      ),
  ...
  static TypeConverter<List<BudgetTransactionFilters>?, String?>
  $converterbudgetTransactionFiltersn = NullAwareTypeConverter.wrap(
    $converterbudgetTransactionFilters,
  );
  static TypeConverter<List<String>, String>
  $convertermemberTransactionFilters = const StringListInColumnConverter();
  static TypeConverter<List<String>?, String?>
  $convertermemberTransactionFiltersn = NullAwareTypeConverter.wrap(
    $convertermemberTransactionFilters,
  );
  static JsonTypeConverter2<SharedOwnerMember, int, int>
  $convertersharedOwnerMember = const EnumIndexConverter<SharedOwnerMember>(
    SharedOwnerMember.values,
  );
  static JsonTypeConverter2<SharedOwnerMember?, int?, int?>
  $convertersharedOwnerMembern = JsonTypeConverter2.asNullable(
...
class Budget extends DataClass implements Insertable<Budget> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || walletFks != null) {
      map['wallet_fks'] = Variable<String>(
        $BudgetsTable.$converterwalletFksn.toSql(walletFks),
      );
    }
    ...
    if (!nullToAbsent || categoryFksExclude != null) {
      map['category_fks_exclude'] = Variable<String>(
        $BudgetsTable.$convertercategoryFksExcluden.toSql(categoryFksExclude),
      );
    }
    map['income'] = Variable<bool>(income);
    map['archived'] = Variable<bool>(archived);
    ...
    if (!nullToAbsent || budgetTransactionFilters != null) {
      map['budget_transaction_filters'] = Variable<String>(
        $BudgetsTable.$converterbudgetTransactionFiltersn.toSql(
          budgetTransactionFilters,
        ),
      );
    }
    if (!nullToAbsent || memberTransactionFilters != null) {
      map['member_transaction_filters'] = Variable<String>(
        $BudgetsTable.$convertermemberTransactionFiltersn.toSql(
          memberTransactionFilters,
        ),
      );
    }
    ...
    if (!nullToAbsent || sharedAllMembersEver != null) {
      map['shared_all_members_ever'] = Variable<String>(
        $BudgetsTable.$convertersharedAllMembersEvern.toSql(
          sharedAllMembersEver,
        ),
      );
    }
  ...
  BudgetsCompanion toCompanion(bool nullToAbsent) {
    return BudgetsCompanion(
      ...
      walletFks:
          walletFks == null && nullToAbsent
              ? const Value.absent()
              : Value(walletFks),
      categoryFks:
          categoryFks == null && nullToAbsent
              ? const Value.absent()
              : Value(categoryFks),
      categoryFksExclude:
          categoryFksExclude == null && nullToAbsent
              ? const Value.absent()
      ...
      walletFk: Value(walletFk),
      budgetTransactionFilters:
          budgetTransactionFilters == null && nullToAbsent
              ? const Value.absent()
              : Value(budgetTransactionFilters),
      memberTransactionFilters:
          memberTransactionFilters == null && nullToAbsent
              ? const Value.absent()
      ...
      sharedKey:
          sharedKey == null && nullToAbsent
              ...
              : Value(sharedKey),
      sharedOwnerMember:
          sharedOwnerMember == null && nullToAbsent
              ? const Value.absent()
      ...
      sharedDateUpdated:
          sharedDateUpdated == null && nullToAbsent
              ...
              : Value(sharedDateUpdated),
      sharedMembers:
          sharedMembers == null && nullToAbsent
              ? const Value.absent()
              : Value(sharedMembers),
      sharedAllMembersEver:
          sharedAllMembersEver == null && nullToAbsent
              ? const Value.absent()
  ...
  factory Budget.fromJson(
    ...
    return Budget(
      ...
      categoryFksExclude: serializer.fromJson<List<String>?>(
        json['categoryFksExclude'],
      ),
      income: serializer.fromJson<bool>(json['income']),
      archived: serializer.fromJson<bool>(json['archived']),
      addedTransactionsOnly: serializer.fromJson<bool>(
        json['addedTransactionsOnly'],
      ),
      periodLength: serializer.fromJson<int>(json['periodLength']),
      reoccurrence: $BudgetsTable.$converterreoccurrencen.fromJson(
        serializer.fromJson<int?>(json['reoccurrence']),
      ),
      dateCreated: serializer.fromJson<DateTime>(json['dateCreated']),
      dateTimeModified: serializer.fromJson<DateTime?>(
      ...
      budgetTransactionFilters: serializer
          .fromJson<List<BudgetTransactionFilters>?>(
            json['budgetTransactionFilters'],
          ),
      memberTransactionFilters: serializer.fromJson<List<String>?>(
        json['memberTransactionFilters'],
      ),
      sharedKey: serializer.fromJson<String?>(json['sharedKey']),
      sharedOwnerMember: $BudgetsTable.$convertersharedOwnerMembern.fromJson(
        serializer.fromJson<int?>(json['sharedOwnerMember']),
      ),
      sharedDateUpdated: serializer.fromJson<DateTime?>(
        json['sharedDateUpdated'],
      ),
      sharedMembers: serializer.fromJson<List<String>?>(json['sharedMembers']),
      sharedAllMembersEver: serializer.fromJson<List<String>?>(
        json['sharedAllMembersEver'],
      ),
      isAbsoluteSpendingLimit: serializer.fromJson<bool>(
        json['isAbsoluteSpendingLimit'],
      ),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'categoryFksExclude': serializer.toJson<List<String>?>(
        categoryFksExclude,
      ),
      'income': serializer.toJson<bool>(income),
      'archived': serializer.toJson<bool>(archived),
      ...
      'memberTransactionFilters': serializer.toJson<List<String>?>(
        memberTransactionFilters,
      ),
      'sharedKey': serializer.toJson<String?>(sharedKey),
      ...
      'sharedAllMembersEver': serializer.toJson<List<String>?>(
        sharedAllMembersEver,
      ),
      'isAbsoluteSpendingLimit': serializer.toJson<bool>(
        isAbsoluteSpendingLimit,
      ),
    };
  }
  ...
  Budget copyWith({
    ...
    categoryFksExclude:
        categoryFksExclude.present
            ? categoryFksExclude.value
            : this.categoryFksExclude,
    income: income ?? this.income,
    archived: archived ?? this.archived,
    addedTransactionsOnly: addedTransactionsOnly ?? this.addedTransactionsOnly,
    periodLength: periodLength ?? this.periodLength,
    reoccurrence: reoccurrence.present ? reoccurrence.value : this.reoccurrence,
    dateCreated: dateCreated ?? this.dateCreated,
    dateTimeModified:
    ...
    walletFk: walletFk ?? this.walletFk,
    budgetTransactionFilters:
        budgetTransactionFilters.present
            ? budgetTransactionFilters.value
            : this.budgetTransactionFilters,
    memberTransactionFilters:
        memberTransactionFilters.present
            ? memberTransactionFilters.value
            : this.memberTransactionFilters,
    sharedKey: sharedKey.present ? sharedKey.value : this.sharedKey,
    sharedOwnerMember:
        sharedOwnerMember.present
  ...
  Budget copyWithCompanion(BudgetsCompanion data) {
    return Budget(
      ...
      categoryFksExclude:
          data.categoryFksExclude.present
              ? data.categoryFksExclude.value
              : this.categoryFksExclude,
      income: data.income.present ? data.income.value : this.income,
      archived: data.archived.present ? data.archived.value : this.archived,
      addedTransactionsOnly:
          data.addedTransactionsOnly.present
      ...
      walletFk: data.walletFk.present ? data.walletFk.value : this.walletFk,
      budgetTransactionFilters:
          data.budgetTransactionFilters.present
              ? data.budgetTransactionFilters.value
              : this.budgetTransactionFilters,
      memberTransactionFilters:
          data.memberTransactionFilters.present
              ? data.memberTransactionFilters.value
              : this.memberTransactionFilters,
      sharedKey: data.sharedKey.present ? data.sharedKey.value : this.sharedKey,
      sharedOwnerMember:
          data.sharedOwnerMember.present
      ...
      sharedDateUpdated:
          data.sharedDateUpdated.present
              ...
              : this.sharedDateUpdated,
      sharedMembers:
          data.sharedMembers.present
              ? data.sharedMembers.value
              : this.sharedMembers,
      sharedAllMembersEver:
          data.sharedAllMembersEver.present
              ? data.sharedAllMembersEver.value
              : this.sharedAllMembersEver,
      isAbsoluteSpendingLimit:
          data.isAbsoluteSpendingLimit.present
...
class BudgetsCompanion extends UpdateCompanion<Budget> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (categoryFksExclude.present) {
      map['category_fks_exclude'] = Variable<String>(
        $BudgetsTable.$convertercategoryFksExcluden.toSql(
          categoryFksExclude.value,
        ),
      );
    }
    ...
    if (addedTransactionsOnly.present) {
      map['added_transactions_only'] = Variable<bool>(
        addedTransactionsOnly.value,
      );
    }
    if (periodLength.present) {
      map['period_length'] = Variable<int>(periodLength.value);
    ...
    if (sharedOwnerMember.present) {
      map['shared_owner_member'] = Variable<int>(
        $BudgetsTable.$convertersharedOwnerMembern.toSql(
          sharedOwnerMember.value,
        ),
      );
    }
    ...
    if (isAbsoluteSpendingLimit.present) {
      map['is_absolute_spending_limit'] = Variable<bool>(
        isAbsoluteSpendingLimit.value,
      );
    }
    if (rowid.present) {
      map['rowid'] = Variable<int>(rowid.value);
...
class $CategoryBudgetLimitsTable extends CategoryBudgetLimits
  ...
  static const VerificationMeta _categoryLimitPkMeta = const VerificationMeta(
    'categoryLimitPk',
  );
  @override
  ...
  static const VerificationMeta _budgetFkMeta = const VerificationMeta(
    'budgetFk',
  );
  @override
  ...
  CategoryBudgetLimit map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return CategoryBudgetLimit(
      categoryLimitPk:
          attachedDatabase.typeMapping.read(
            DriftSqlType.string,
            data['${effectivePrefix}category_limit_pk'],
          )!,
      categoryFk:
          attachedDatabase.typeMapping.read(
            DriftSqlType.string,
      ...
      budgetFk:
          attachedDatabase.typeMapping.read(
            DriftSqlType.string,
            data['${effectivePrefix}budget_fk'],
          )!,
      amount:
          attachedDatabase.typeMapping.read(
            DriftSqlType.double,
...
class $AssociatedTitlesTable extends AssociatedTitles
  ...
  static const VerificationMeta _associatedTitlePkMeta = const VerificationMeta(
    'associatedTitlePk',
  );
  @override
  ...
  @override
  TransactionAssociatedTitle map(
...
class TransactionAssociatedTitle extends DataClass
  ...
  factory TransactionAssociatedTitle.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  TransactionAssociatedTitle copyWithCompanion(AssociatedTitlesCompanion data) {
    return TransactionAssociatedTitle(
      associatedTitlePk:
          data.associatedTitlePk.present
...
class $AppSettingsTable extends AppSettings
  ...
  static const VerificationMeta _settingsPkMeta = const VerificationMeta(
    'settingsPk',
  );
  @override
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('settings_pk')) {
      context.handle(
        _settingsPkMeta,
        settingsPk.isAcceptableOrUnknown(data['settings_pk']!, _settingsPkMeta),
      );
    }
  ...
  AppSetting map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return AppSetting(
      settingsPk:
          attachedDatabase.typeMapping.read(
            DriftSqlType.int,
            data['${effectivePrefix}settings_pk'],
          )!,
      settingsJSON:
          attachedDatabase.typeMapping.read(
            DriftSqlType.string,
            data['${effectivePrefix}settings_j_s_o_n'],
          )!,
      dateUpdated:
          attachedDatabase.typeMapping.read(
            DriftSqlType.dateTime,
...
class $ScannerTemplatesTable extends ScannerTemplates
  ...
  static const VerificationMeta _scannerTemplatePkMeta = const VerificationMeta(
    'scannerTemplatePk',
  );
  @override
  ...
  static const VerificationMeta _containsMeta = const VerificationMeta(
    'contains',
  );
  @override
  ...
  static const VerificationMeta _defaultCategoryFkMeta = const VerificationMeta(
    'defaultCategoryFk',
  );
  @override
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<ScannerTemplate> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class ScannerTemplate extends DataClass implements Insertable<ScannerTemplate> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['amount_transaction_before'] = Variable<String>(
      amountTransactionBefore,
    );
  ...
  factory ScannerTemplate.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return ScannerTemplate(
      ...
      titleTransactionBefore: serializer.fromJson<String>(
        json['titleTransactionBefore'],
      ),
      titleTransactionAfter: serializer.fromJson<String>(
        json['titleTransactionAfter'],
      ),
      amountTransactionBefore: serializer.fromJson<String>(
        json['amountTransactionBefore'],
      ),
      amountTransactionAfter: serializer.fromJson<String>(
        json['amountTransactionAfter'],
      ),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'titleTransactionBefore': serializer.toJson<String>(
        titleTransactionBefore,
      ),
      'titleTransactionAfter': serializer.toJson<String>(titleTransactionAfter),
      'amountTransactionBefore': serializer.toJson<String>(
        amountTransactionBefore,
      ),
      'amountTransactionAfter': serializer.toJson<String>(
        amountTransactionAfter,
      ),
  ...
  ScannerTemplate copyWith({
    ...
    titleTransactionAfter: titleTransactionAfter ?? this.titleTransactionAfter,
    amountTransactionBefore:
  ...
  ScannerTemplate copyWithCompanion(ScannerTemplatesCompanion data) {
    return ScannerTemplate(
      scannerTemplatePk:
          data.scannerTemplatePk.present
...
class ScannerTemplatesCompanion extends UpdateCompanion<ScannerTemplate> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (titleTransactionBefore.present) {
      map['title_transaction_before'] = Variable<String>(
        titleTransactionBefore.value,
      );
    }
    if (titleTransactionAfter.present) {
      map['title_transaction_after'] = Variable<String>(
        titleTransactionAfter.value,
      );
    }
    if (amountTransactionBefore.present) {
      map['amount_transaction_before'] = Variable<String>(
        amountTransactionBefore.value,
      );
    }
    if (amountTransactionAfter.present) {
      map['amount_transaction_after'] = Variable<String>(
        amountTransactionAfter.value,
      );
    }
...
abstract class _$FinanceDatabase extends GeneratedDatabase {
  ...
  late final $ScannerTemplatesTable scannerTemplates = $ScannerTemplatesTable(
    this,
  );
...
final class $$WalletsTableReferences
    extends
        BaseReferences<_$FinanceDatabase, $WalletsTable, TransactionWallet> {
  $$WalletsTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static MultiTypedResultKey<$ObjectivesTable, List<Objective>>
  _objectivesRefsTable(_$FinanceDatabase db) => MultiTypedResultKey.fromTable(
    db.objectives,
    aliasName: $_aliasNameGenerator(
      db.wallets.walletPk,
      db.objectives.walletFk,
    ),
  );
  ...
  $$ObjectivesTableProcessedTableManager get objectivesRefs {
    final manager = $$ObjectivesTableTableManager($_db, $_db.objectives).filter(
      (f) => f.walletFk.walletPk.sqlEquals($_itemColumn<String>('wallet_pk')!),
    );
  ...
  _transactionsRefsTable(_$FinanceDatabase db) => MultiTypedResultKey.fromTable(
    db.transactions,
    aliasName: $_aliasNameGenerator(
      db.wallets.walletPk,
      db.transactions.walletFk,
    ),
  );
  ...
  static MultiTypedResultKey<$BudgetsTable, List<Budget>> _budgetsRefsTable(
    ...
    db.budgets,
    aliasName: $_aliasNameGenerator(db.wallets.walletPk, db.budgets.walletFk),
  );
  ...
  >
  _categoryBudgetLimitsRefsTable(_$FinanceDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.categoryBudgetLimits,
        aliasName: $_aliasNameGenerator(
          db.wallets.walletPk,
          db.categoryBudgetLimits.walletFk,
        ),
      );
  ...
  $$ScannerTemplatesTableProcessedTableManager get scannerTemplatesRefs {
    final manager = $$ScannerTemplatesTableTableManager(
      $_db,
      $_db.scannerTemplates,
    ).filter(
      (f) => f.walletFk.walletPk.sqlEquals($_itemColumn<String>('wallet_pk')!),
    );

    final cache = $_typedResult.readTableOrNull(
      _scannerTemplatesRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
...
final class $$CategoriesTableReferences
  ...
  static $CategoriesTable _mainCategoryPkTable(_$FinanceDatabase db) =>
      db.categories.createAlias(
        $_aliasNameGenerator(
          db.categories.mainCategoryPk,
          db.categories.categoryPk,
        ),
      );
  ...
  _categoryBudgetLimitsRefsTable(_$FinanceDatabase db) =>
      MultiTypedResultKey.fromTable(
        ...
        aliasName: $_aliasNameGenerator(
          db.categories.categoryPk,
          db.categoryBudgetLimits.categoryFk,
        ),
      );
  ...
  get categoryBudgetLimitsRefs {
    final manager = $$CategoryBudgetLimitsTableTableManager(
      ...
      (f) => f.categoryFk.categoryPk.sqlEquals(
        $_itemColumn<String>('category_pk')!,
      ),
    );
  ...
  static MultiTypedResultKey<
    ...
    List<TransactionAssociatedTitle>
  >
  _associatedTitlesRefsTable(_$FinanceDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.associatedTitles,
        aliasName: $_aliasNameGenerator(
          db.categories.categoryPk,
          db.associatedTitles.categoryFk,
        ),
      );
  ...
  $$ScannerTemplatesTableProcessedTableManager get scannerTemplatesRefs {
    final manager = $$ScannerTemplatesTableTableManager(
      ...
      (f) => f.defaultCategoryFk.categoryPk.sqlEquals(
        $_itemColumn<String>('category_pk')!,
      ),
    );
                ...
                return [
                  if (categoryBudgetLimitsRefs)
                    ...
                    >(
                      ...
                      referencedItemsForCurrentItem:
                          (item, referencedItems) => referencedItems.where(
                            (e) => e.categoryFk == item.categoryPk,
                          ),
                      typedResults: items,
                    ),
...
final class $$TransactionsTableReferences
  ...
  static $TransactionsTable _pairedTransactionFkTable(_$FinanceDatabase db) =>
      db.transactions.createAlias(
        $_aliasNameGenerator(
          db.transactions.pairedTransactionFk,
          db.transactions.transactionPk,
        ),
      );
  ...
  static $ObjectivesTable _objectiveLoanFkTable(_$FinanceDatabase db) =>
      db.objectives.createAlias(
        $_aliasNameGenerator(
          db.transactions.objectiveLoanFk,
          db.objectives.objectivePk,
        ),
      );
...
final class $$BudgetsTableReferences
  ...
  _categoryBudgetLimitsRefsTable(_$FinanceDatabase db) =>
      MultiTypedResultKey.fromTable(
        ...
        aliasName: $_aliasNameGenerator(
          db.budgets.budgetPk,
          db.categoryBudgetLimits.budgetFk,
        ),
      );
  ...
  get categoryBudgetLimitsRefs {
    final manager = $$CategoryBudgetLimitsTableTableManager(
      ...
      (f) => f.budgetFk.budgetPk.sqlEquals($_itemColumn<String>('budget_pk')!),
    );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<int> order = const Value.absent(),
                Value<String> walletFk = const Value.absent(),
                Value<List<BudgetTransactionFilters>?>
                    budgetTransactionFilters =
                    const Value.absent(),
                Value<List<String>?> memberTransactionFilters =
                    const Value.absent(),
                ...
                if (categoryFk) {
                  state =
                      state.withJoin(
                            currentTable: table,
                            currentColumn: table.categoryFk,
                            referencedTable: $$AssociatedTitlesTableReferences
                                ._categoryFkTable(db),
                            referencedColumn:
                                $$AssociatedTitlesTableReferences
                                    ._categoryFkTable(db)
...
final class $$ScannerTemplatesTableReferences
    extends
        BaseReferences<
          _$FinanceDatabase,
  ...
  static $WalletsTable _walletFkTable(_$FinanceDatabase db) =>
      db.wallets.createAlias(
        $_aliasNameGenerator(db.scannerTemplates.walletFk, db.wallets.walletPk),
      );
...
class $$ScannerTemplatesTableTableManager
    extends
        RootTableManager<
          _$FinanceDatabase,
          $ScannerTemplatesTable,
...
typedef $$ScannerTemplatesTableProcessedTableManager =
    ProcessedTableManager<
      _$FinanceDatabase,
      $ScannerTemplatesTable,
      ScannerTemplate,
...
class $$DeleteLogsTableTableManager
    extends
        RootTableManager<
          ...
          (
            DeleteLog,
            BaseReferences<_$FinanceDatabase, $DeleteLogsTable, DeleteLog>,
          ),
          DeleteLog,
          PrefetchHooks Function()
        > {
